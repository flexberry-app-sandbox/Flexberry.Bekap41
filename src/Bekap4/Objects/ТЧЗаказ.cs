...
namespace IIS.Bekap4
{
    ...
    public class ТЧЗаказ : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Bekap4.DetailArrayOfЕдиницыИзмер fЕдиницыИзмер;
        
        private IIS.Bekap4.DetailArrayOfНоменклатура fНоменклатура;
        ...
        public virtual IIS.Bekap4.DetailArrayOfЕдиницыИзмер ЕдиницыИзмер
        {
            get
            {
                ...
                if ((this.fЕдиницыИзмер == null))
                {
                    this.fЕдиницыИзмер = new IIS.Bekap4.DetailArrayOfЕдиницыИзмер(this);
                }
                IIS.Bekap4.DetailArrayOfЕдиницыИзмер result = this.fЕдиницыИзмер;
        ...
        public virtual IIS.Bekap4.DetailArrayOfНоменклатура Номенклатура
        {
            get
            {
                ...
                if ((this.fНоменклатура == null))
                {
                    this.fНоменклатура = new IIS.Bekap4.DetailArrayOfНоменклатура(this);
                }
                IIS.Bekap4.DetailArrayOfНоменклатура result = this.fНоменклатура;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧЗаказE", typeof(IIS.Bekap4.ТЧЗаказ));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧЗаказ : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Bekap4.DetailArrayOfТЧЗаказ members)

        // *** End programmer edit section *** (IIS.Bekap4.DetailArrayOfТЧЗаказ members)
        ...
        /// </summary>
        public DetailArrayOfТЧЗаказ(IIS.Bekap4.ЗаказПост fЗаказПост) : 
                base(typeof(ТЧЗаказ), ((ICSSoft.STORMNET.DataObject)(fЗаказПост)))
        {
        }
        
        public IIS.Bekap4.ТЧЗаказ this[int index]
        {
            get
            {
                return ((IIS.Bekap4.ТЧЗаказ)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Bekap4.ТЧЗаказ dataobject)
        {
